...
namespace NOSQLTask.Repository
{
    public interface IInvoiceRepository
    {
        ...
        Task<IEnumerable<Invoice>> GetClientsIdByProduct(string ProductId);
    ...
    public class InvoiceRepository : IInvoiceRepository
    {
        ...
        public async Task<IEnumerable<Invoice>> GetClientsIdByProduct(string ProductId)
        {
            var filter = Builders<Invoice>.Filter.AnyEq(x => x.ProductIds, ProductId);
